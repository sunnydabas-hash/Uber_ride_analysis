...
SELECT
    VEHICLE_TYPE,
    COUNT(*) AS TOTAL_RIDES,
    SUM(CASE WHEN CANCELLED_RIDES_BY_CUSTOMER = '1' THEN 1 ELSE 0 END) AS CUSTOMER_CANCELS,
    SUM(CASE WHEN CANCELLED_RIDES_BY_DRIVER = '1' THEN 1 ELSE 0 END) AS DRIVER_CANCELS,
    ROUND(SUM(CASE WHEN CANCELLED_RIDES_BY_CUSTOMER = '1' OR CANCELLED_RIDES_BY_DRIVER = '1' 
            THEN 1 ELSE 0 END) * 100.0/COUNT(*),2) AS TOTAL_CANCEL_PCT
